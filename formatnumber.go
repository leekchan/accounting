...
func formatNumberString(x string, precision int, thousand string, decimalStr string, symbol string) string {
...
func FormatNumber(value interface{}, precision int, thousand string, decimalStr string, symbol string) string {
	...
	return formatNumberString(x, precision, thousand, decimalStr, symbol)
}
